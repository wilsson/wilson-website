...
description: "Entorno de desarrollo local para posgreSQL"
date: "2022-03-28"
tags:
    - Docker
    - PostgreSQL
...
En este post te enseño a crear una base de datos en postgreSQL y pgAdminuna herramienta de interface gráfica para poder administrarlo, todo esto con docker.
