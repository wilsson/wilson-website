        ...
        <main className="px-8">
          <div className="mx-auto max-w-2xl flex justify-between items-start mt-28 flex-col flex-col-reverse sm:flex-row">
            <div className="sm:pr-14">
              <h1 className="text-white text-4xl font-[800] mb-2">
                Wilson Flores
              </h1>
              <h2 className="text-gray-300 mb-4">
                Sotfware Engineer FullStack at{' '}
                <a
                  href="https://www.pedidosya.com"
                  className="text-red-200 underline font-medium"
                >
                  PedidosYa
                </a>
              </h2>
              <p className="text-gray-400 mb-8">
                In this place I will share everything I have learned in my
                technology career.
              </p>
            ...
            <img
              className="grayscale-[70%] w-28 rounded-full mb-6"
              src="/avatar.jpeg"
            />
          </div>
